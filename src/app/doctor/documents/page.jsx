        ...
        <div className='py-2 sm:py-3 px-2 sm:px-4 flex flex-col min-h-screen'>
            <header className="bg-white border-b border-gray-200 px-3 sm:px-6 py-2 sm:py-4 rounded-lg mb-3 sm:mb-4">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    {/* Left side - Title */}
                    <div>
                        <h1 className="text-lg sm:text-xl font-semibold text-gray-900">Patient Documents</h1>
                        <p className="text-xs sm:text-sm text-gray-600">Manage patient files and medical records</p>
                    </div>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 justify-end">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3 ml-2 sm:ml-3 pl-2 sm:pl-3 border-l border-gray-200">
                            <div className="text-right hidden sm:block">
                                <p className="text-gray-900 text-xs sm:text-sm font-medium">Dr. Sarah Wilson</p>

  ...
  return (
    <div className="font-poppins min-h-screen bg-blue-500/25 bg-cover bg-center py-4 w-full flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex flex-col justify-center items-center flex-1 p-4">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 sm:mb-8 text-white text-center">
          Connecting Doctors and Patients Seamlessly
        </h1>
        <p className="text-white mb-6 sm:mb-8 text-sm sm:text-base text-center max-w-md">
          Join the platform that makes healthcare communication simple, secure,
          and personal.
        </p>
      </div>
      ...
      <div className="flex p-3 sm:p-6 gap-4 sm:gap-8 flex-1 items-center justify-center">
        <div className="bg-card w-full max-w-md p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl shadow-lg overflow-auto max-h-screen sm:max-h-none">
          {/* Header */}
          <div className="flex flex-col sm:flex-row sm:justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
            <h1 className="text-sm sm:text-base">
              Welcome to{" "}
              <span className="text-blue-500 font-semibold">SeamCare</span>
            </h1>
          ...
          {/* Title */}
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-medium mb-4 sm:mb-4">
            Register
          </h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="">
            ...
            <div className="flex items-center justify-between mb-4 sm:mb-6 text-xs sm:text-sm">
              ...
              {/* Line */}
              <div
                className={`flex-1 h-1 mx-1 sm:mx-2 ${step > 1 ? "bg-blue-500" : "bg-gray-300"}`}
              ></div>
              ...
              {/* Line */}
              <div
                className={`flex-1 h-1 mx-1 sm:mx-2 ${step > 2 ? "bg-blue-500" : "bg-gray-300"}`}
              ></div>
              ...
              <div className="flex flex-col items-center flex-1">
                ...
                <p className="text-xs sm:text-sm mt-1 text-center">
                  {role === "patient" ? "Patient Info" : "Doctor Info"}
                </p>
              </div>
            </div>

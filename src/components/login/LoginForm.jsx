  ...
  return (
    <div className="font-poppins min-h-screen bg-blue-500/25 bg-cover bg-center py-4 w-full flex flex-col lg:flex-row">
      ...
      <div className="flex p-3 sm:p-6 gap-4 sm:gap-8 flex-1 items-center justify-center">
        <div className="bg-card w-full max-w-md p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl shadow-lg">
          {/* Header */}
          ...
          {/* Title */}
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-medium mb-4 sm:mb-6 lg:mb-8">
            Sign in
          </h1>
          ...
          {/* Error Message */}
          {error && (
            <p className="text-red-500 mb-3 sm:mb-4 text-xs sm:text-sm">
              {error}
            </p>
          )}
